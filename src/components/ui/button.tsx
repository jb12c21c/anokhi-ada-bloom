  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-brand-purple bg-background text-primary hover:bg-brand-purple-light hover:border-brand-purple/80",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-soft",
        ghost: "hover:bg-brand-purple-light hover:text-primary",
        link: "text-primary underline-offset-4 hover:underline",
        elegant: "gradient-primary text-primary border-0 shadow-soft hover:shadow-hover hover:scale-105",
        soft: "bg-brand-lavender text-primary hover:bg-brand-purple hover:text-primary-foreground shadow-soft",
      },
      size: {
